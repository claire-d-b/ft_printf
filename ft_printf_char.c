...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/03 12:19:37 by clde-ber          #+#    #+#             */
/*   Updated: 2020/03/05 16:10:35 by clde-ber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	width_len_conditions(t_flag *help, int j, char c)
{
	if ((j < help->width - 1 && (help->precision == -1 || help->set_prec == 0))
		...
		help->precision != -1 && help->precision < help->width)) && c == 'c')
		|| (c != 'c' && ((j < help->width - 1 && (help->set_prec == 0 ||
		(help->set_prec == 1 && (help->precision <= 1 && help->precision != 0))
