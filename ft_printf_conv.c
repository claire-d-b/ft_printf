...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/03 12:09:58 by clde-ber          #+#    #+#             */
/*   Updated: 2020/03/05 17:58:39 by clde-ber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	manage_pointers(t_flag *help, char c, va_list args)
{
	...
	if (!(l = (unsigned long long)va_arg(args, void *)) &&
		(help->set_prec == 0 || (help->set_prec == 1 &&
		help->precision != 0)))
	{
		help->precision += 2;
	...
	else
	{
		help->precision += 2;
		help->free = 1;
		help->ret += ft_putstr_len(c, (char *)join_a_free("0x",
