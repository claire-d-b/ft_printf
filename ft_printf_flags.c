...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/03 12:09:11 by clde-ber          #+#    #+#             */
/*   Updated: 2020/03/05 17:53:55 by clde-ber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	record_precision(int j, t_flag *help, const char *format,
	va_list args)
{
	help->set_prec = 1;
...
void		fill_struct(t_flag *help, const char *format, va_list args)
{
	...
	j = 1;
	if (format[j] && (is_flag(format[j]) || is_conv(format[j])))
	{
